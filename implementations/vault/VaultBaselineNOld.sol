...
contract VaultBaselineNOld is ERC20 {
    ...
    constructor (address _token, address _controller) public ERC20(
        string(abi.encodePacked("normalized ", ERC20(_token).name())),
    ...
    function priceE18() public pure returns (uint) {
        return 1e18;
    }
}
